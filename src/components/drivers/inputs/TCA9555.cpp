...
int8_t TCA9555::TCA955_I2C_write(uint8_t I2C_bus, uint8_t *data, size_t size)
{
...
int8_t TCA9555::TCA955_I2C_read(uint8_t I2C_bus, uint8_t *data, size_t size)
{
    if (size == 0)
    {
        return ESP_OK;
    ...
    i2c_master_read_byte(cmd, data + size - 1, I2C_MASTER_ACK);
    i2c_master_stop(cmd);
...
bool TCA9555::TCA9555_pinMode(uint8_t pin)
{
...
int16_t TCA9555::TCA9555_readInputs(void)
{
